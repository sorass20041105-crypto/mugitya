...
OUTFIT_LIBRARY_MALE = {
    "Streetwear": {
        "inner": ["Oversized Tee", "Long Sleeve Tee"],
        "outer": ["Bomber Jacket", "Hoodie"],
        "bottom": ["Cargo Pants", "Baggy Jeans"]
    },
    "Casual": {
        "inner": ["Henley Shirt", "Crew Neck Tee"],
        "outer": ["Denim Jacket", "Light Coat"],
        "bottom": ["Jeans", "Chinos"]
    },
    "Formal": {
        "inner": ["Dress Shirt"],
...
OUTFIT_LIBRARY_FEMALE = {
    "Streetwear": {
        "inner": ["Crop Tee", "Loose Tee"],
        "outer": ["Short Jacket", "Hoodie"],
        "bottom": ["Wide Pants", "Cargo Pants"]
    },
    "Casual": {
        "inner": ["Blouse", "Knit Top"],
        "outer": ["Cardigan", "Light Coat"],
        "bottom": ["Skirt", "Denim"]
    },
    "Formal": {
        "inner": ["Blouse"],
...
if gender == "Male":
    ...
    OUTFIT_LIBRARY = OUTFIT_LIBRARY_FEMALE
else:
    OUTFIT_LIBRARY = OUTFIT_LIBRARY_UNISEX
...
for i, genre in enumerate(top_genres):
    if genre not in OUTFIT_LIBRARY:
        continue
